...
pub struct SignedDelegateActionAsBase64 {
    pub inner: unc_primitives::action::delegate::SignedDelegateAction,
}
...
impl std::str::FromStr for SignedDelegateActionAsBase64 {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(Self {
            inner: unc_primitives::action::delegate::SignedDelegateAction::try_from_slice(
...
impl std::fmt::Display for SignedDelegateActionAsBase64 {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let base64_signed_delegate_action = unc_primitives::serialize::to_base64(
