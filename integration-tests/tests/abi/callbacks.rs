...
fn test_callbacks_result() -> utility_cli_rs::CliResult {
    let abi_root = generate_abi_fn! {
        pub fn foo(
            &self,
            #[callback_result] a: Result<String, unc_sdk::PromiseError>,
            #[callback_result] b: Result<u32, unc_sdk::PromiseError>
        ) {}
    };
...
fn test_callbacks_mixed_with_params() -> utility_cli_rs::CliResult {
    let abi_root = generate_abi_fn! {
        pub fn foo(
            ...
            #[callback_unwrap] a: bool,
            b: u32,
            #[callback_result] c: Result<String, unc_sdk::PromiseError>,
            d: i32,
