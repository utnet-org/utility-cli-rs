...
#[derive(Debug, Clone)]
pub struct ContractContext(crate::commands::contract::deploy::ContractFileContext);
...
impl ContractContext {
    pub fn from_previous_context(
        ...
        Ok(Self(
            crate::commands::contract::deploy::ContractFileContext {
...
impl From<ContractContext> for crate::commands::contract::deploy::ContractFileContext {
