...
impl AddAccessWithSeedPhraseActionContext {
    pub fn from_previous_context(
        ...
        // This is the HD path that is used in unc Wallet for plaintext seed phrase generation and, subsequently, for account recovery by a seed phrase.
        let unc_wallet_seed_phrase_hd_path_default =
            slip10::BIP32Path::from_str("m/44'/397'/0'").unwrap();
        let public_key = crate::common::get_public_key_from_seed_phrase(
            unc_wallet_seed_phrase_hd_path_default,
